...
namespace Breakout.BreakoutStates {
    public class ScoreScreen : IGameState {
        private static ScoreScreen instance = null;
        ...
        public ScoreScreen(){
            text = new[]{ 
                new Text("You won!", new Vec2F(0.2f,0.4f), new Vec2F(0.4f,0.4f)),
                new Text(string.Format("{0} points", Points.GetTally()), new Vec2F(0.2f,0.3f), new Vec2F(0.4f,0.4f)),
            };
            text[0].SetColor(new Vec3F(0.0f,1.0f,0.0f));
            text[1].SetColor(new Vec3F(0.0f,1.0f,0.0f));
            menuButtons = new []{
        ...
        /// <summary>
        ///  Returns the local instance field or resets the instance of ScoreScreen
        /// </summary>
        /// <param>
        ///  Null
        /// </param>
        ...
        public static ScoreScreen GetInstance() {
            if (ScoreScreen.instance == null) {
                ScoreScreen.instance = new ScoreScreen();
                ScoreScreen.instance.ResetState();
            }
            return ScoreScreen.instance;
        }
        ...
        /// <summary>
        ///  Renders the different elements in the ScoreScreen State
        /// </summary>
        /// <param>
        ///  Null
        /// </param>
        ...
        public void RenderState() {
            ...
            Entity backgroundImage = new Entity(new StationaryShape(new Vec2F(0.0f,0.0f), new Vec2F(1.0f,1.0f)),
                new Image(Path.Combine("Assets", "Images", "win.png")));
        ...
        /// <summary>
        ///  Handles input from the player in the ScoreScreen State
        /// </summary>
        /// <param action>
